...
class Identity {
 public:
  ...
  // Is nodeName() safe to use as an MQTT clientId? False means it is the
  // shared literal, and every broker transport must stay down rather than
  // evict a sibling.
  static bool brokerNameUsable();
