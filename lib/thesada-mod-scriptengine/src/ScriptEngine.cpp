...
void ScriptEngine::createState() {
  ...
  // also dropped - fs.rm shell command remains for LittleFS cleanup.
  lua_pushnil(gL); lua_setglobal(gL, "io");
  lua_pushnil(gL); lua_setglobal(gL, "os");
  lua_pushnil(gL); lua_setglobal(gL, "debug");
  lua_pushnil(gL); lua_setglobal(gL, "package");
  lua_pushnil(gL); lua_setglobal(gL, "require");
  lua_pushnil(gL); lua_setglobal(gL, "dofile");
  lua_pushnil(gL); lua_setglobal(gL, "loadfile");
  lua_pushnil(gL); lua_setglobal(gL, "load");
